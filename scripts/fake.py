...
if __name__ == '__main__':
    os.environ.setdefault("DJANGO_SETTINGS_MODULE", "CMblog2020.settings.local")
    django.setup()
    ...
    user = User.objects.create_superuser('cuimin_test', 'cuimin@cmblog.com', 'cuimin')

    category_list = ['学习Python笔记', '项目', '资源', '生活感悟', 'test category']
    ...
    for post in Post.objects.all()[:20]:
        ...
        delta_in_days = '_' + str((timezone.now() - post_created_time).days) + 'd'
